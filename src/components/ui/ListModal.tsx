...
const ListModal = ({ isOpen, onClose, matchId }: ListModalProps) => {
  const { lists, createList, addMatchToList, isMatchInList, openCreateListModal, isCreateListModalOpen, closeCreateListModal } = useLists();
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          {creatingList ? (
            ...
            <div className="flex space-x-2">
              ...
              >
                <ListPlus className="mr-2 h-4 w-4" /> Advanced
              </Button>
            </div>
          )}
