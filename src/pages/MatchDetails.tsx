...
const MatchDetails = () => {
  ...
  useEffect(() => {
    ...
    const img = new Image();
    img.src = match.poster || placeholderImg;
  ...
  return (
    <MainLayout>
      <div className="page-transition">
        {/* Match Hero Section - Enhanced for better responsiveness */}
        <div className="relative w-full overflow-hidden -mt-8 sm:-mx-8 md:-mx-12 lg:-mx-24">
          ...
          <AspectRatio ratio={isMobile ? 4/5 : 16/9} className="min-h-[300px] max-h-[70vh]">
            ...
            <div className="relative h-full container mx-auto px-4 sm:px-6 flex flex-col justify-end pb-6 sm:pb-8 md:pb-12">
              ...
              >
                <motion.h1 
                  className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg break-words hyphens-auto"
                ...
                >
                  ...
                  {highlightLink && (
                    <a 
                      ...
                      className="flex items-center gap-2 bg-black/50 backdrop-blur-sm rounded-lg px-3 py-1.5 hover:bg-black/70 transition-colors"
                    >
          ...
          <div className="container max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="md:col-span-1 space-y-6">
                {/* Rating card with improved spacing */}
                ...
                {/* Match details card with improved layout */}
                <Card>
                  <CardContent className="p-4 sm:p-6">
                    <h2 className="text-lg font-semibold mb-4">Match Details</h2>
                    <p className="text-sm text-muted-foreground mb-4">{match?.description || "No description available."}</p>
              ...
              <div className="md:col-span-2">
                <Card className="h-full">
                  <CardContent className="p-4 sm:p-6">
                    ...
                    {/* Fan review with improved spacing */}
                    <div className="mb-6">
